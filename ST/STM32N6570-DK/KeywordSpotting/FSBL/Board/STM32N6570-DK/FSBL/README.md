...
## FSBL Layer for STM32N6570-DK_BSP board
...
#### Open [FSBL Example](https://github.com/Open-CMSIS-Pack/STM32N6570-DK_BSP/tree/main/Examples/FSBL)
...
#### [Create new solution](https://mdk-packs.github.io/vscode-cmsis-solution-docs/create_app.html) in VS Code based on [Reference Applications](https://open-cmsis-pack.github.io/cmsis-toolbox/ReferenceApplications/) with FSBL Layer for STM32N6570-DK board and update
...
#### Copy the contents of the previous root folder `FSBL Example` project into the current root folder `Reference_Applications` project
