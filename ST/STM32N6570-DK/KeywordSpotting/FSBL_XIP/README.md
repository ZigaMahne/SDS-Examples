...
- Complete the [STM32N6570-DK BSP FSBL_XIP layer](https://github.com/Open-CMSIS-Pack/STM32N6570-DK_BSP/blob/main/Layers/FSBL_XIP/README.md) setup before using the SDS application project, including building the flash algorithm and FSBL outputs.
